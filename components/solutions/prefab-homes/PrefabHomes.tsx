...
function PrefabHomes() {
  ...
  function handlePrefab(item: any): void {
    setOpenModal(true)
    setHomeData(item)
    // console.log(item);
  }
  return (
    <div className='grid grid-cols-3 max-lg:grid-cols-2 max-sm:grid-cols-1 gap-3 pt-[100px] p-5'>
      ...
      <div className='bg-white p-5'>
        ...
        <button 
          onClick={() => handlePrefab(solutions[1])}
          className="flex justify-center items-center p-2 bg-main-100 w-full rounded hover:shadow-lg text-white"
        >
          Proceed with One Bed
        </button>
      </div>
      ...
      <div className='bg-white p-5'>
        ...
        <button 
          onClick={() => handlePrefab(solutions[2])}
          className="flex justify-center items-center p-2 bg-main-100 w-full rounded hover:shadow-lg text-white"
        >
          Proceed with Two Bed
        </button>
      </div>

      
      <PrefabHomesModal openModal={openModal} setOpenModal={setOpenModal} homeData={homeData}/>
    </div>
  )
}
