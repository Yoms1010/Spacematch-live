        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-12 text-center">
            ...
            <Link href={"/property/start-coownership"} className="flex flex-col items-center hover:text-main-100">
              ...
              <p className="text-gray-600">Connect with like-minded individuals or groups who share your vision for co-ownership. Our platform makes it easy to find compatible partners.</p>
              <div className='w-full p-2 my-4 transform transition-all duration-500 ease-in-out hover:scale-110 rounded-xl border border-main-100 hover:text-main-100'>Proceed to planning</div>
            </Link>
            {/* Step 2 */}
            <Link href={
              client.length > 0
            ...
            >
              ...
              <div className='w-full p-2 my-4 transform transition-all duration-500 ease-in-out hover:scale-110 border border-main-100 hover:text-main-100 rounded-xl'>Proceed to Matched Properties</div>
            </Link>
            {/* Step 3 */}
            <Link href={"/products"} className="flex flex-col items-center hover:text-main-100">
              ...
              <div className='w-full p-2 my-4 transform transition-all duration-500 ease-in-out hover:scale-110 rounded-xl border border-main-100 hover:text-main-100'>Proceed to Build</div>
            </Link>
          </div>
        </div>
      </section>
