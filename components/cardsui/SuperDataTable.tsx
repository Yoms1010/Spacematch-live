...
import { Trash2Icon, VerifiedIcon } from 'lucide-react';
...
const SuperDataTable = <T extends Record<string, any>>({ data, columns, pageSize = 10, title, children}: DataTableProps<T>) => {
