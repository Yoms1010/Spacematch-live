...
const VendorProfileCompletion = ({userData, vendor}: {userData: any, vendor: any}) => {
  const [currentView, setCurrentView] = useState(typeof window != undefined && window.localStorage.getItem("currentView"));
        ...
        return (
          <div className="space-y-4">
            ...
            <input
              ...
              value={business_address || formData.businessAddress}
              onChange={handleChange}
            ...
            <input
              type="tel"
              name="businessPhone"
              value={business_phone||formData.businessPhone}
              onChange={handleChange}
            ...
            <input
              type="email"
              name="businessEmail"
              value={business_email || formData.businessEmail}
              onChange={handleChange}
            ...
            <input
              ...
              value={business_reg_no || formData.businessRegNumber}
              onChange={handleChange}
            ...
            <input
              type="text"
              name="businessType"
              value={business_type||formData.businessType}
              onChange={handleChange}
            ...
            <textarea
              ...
              value={service_offering||formData.serviceOfferings}
              onChange={handleChange}
